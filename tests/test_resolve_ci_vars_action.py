...
class TestResolveCiVarsAction:
    ...
    def test_standard_ci_variables(self, act_runner: ActRunner):
    ...
    def test_workflow_dispatch_with_pr_input(self, act_runner: ActRunner):
    ...
    def test_combined_inputs(self, act_runner: ActRunner):
